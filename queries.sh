...
echo "$($PSQL "SELECT SUM(games.winner_goals) + SUM(games.opponent_goals) FROM games")"
...
echo "$($PSQL "SELECT GREATEST(winner_goals, opponent_goals) FROM games WHERE winner_goals=(SELECT MAX(GREATEST(winner_goals, opponent_goals)) FROM games) OR opponent_goals=(SELECT MAX(GREATEST(winner_goals, opponent_goals)) FROM games)")"
